  ...
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div className="flex flex-col sm:flex-row justify-between items-center mb-8 gap-4">
        <h2 className="text-3xl font-bold bg-gradient-to-r from-indigo-600 via-purple-600 to-blue-600 text-transparent bg-clip-text text-center sm:text-left w-full sm:w-auto">
        ...
        <div className="flex items-center space-x-4">
          ...
          >
            <i
              className={
                expandAll
                  ? "bx bx-collapse-alt text-lg"
                  : "bx bx-expand-alt text-lg"
              }
            ></i>
